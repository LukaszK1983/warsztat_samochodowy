    ...
    <table cellpadding="10">
        ...
        <c:forEach var="vehicle" items="${vehicles}">
            <tr>
                ...
                <td><button class="btn btn-primary" ><a href="editVehicle?id=${vehicle.id}" class="ame">Edycja</a></button>
        ...
        <tr>
            ...
            <td><button class="btn btn-primary" ><a href="addVehicle" class="ame">Dodaj nowy pojazd</a></button></td>
        </tr>
    </table>
</div>
